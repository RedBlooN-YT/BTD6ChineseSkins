...
[assembly: MelonInfo(typeof(ChineseSkins.Main), ModHelperData.Name, ModHelperData.Version, ModHelperData.RepoOwner)]
[assembly: MelonGame("Ninja Kiwi", "BloonsTD6")]

namespace ChineseSkins;
...
public class Main : BloonsTD6Mod
{
	...
	public override void OnGameModelLoaded(GameModel model)
	{
		...
		{
			assetToReplace = new AudioClipReference { guidRef = "2ec103c1a89a2dc46873262713bd47b1" }, // Place 1
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearPlace")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "60b663ec35ef9cb4f9ddb39d4261dc74" }, // Place 2
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearPlace")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "12baadbccd77e764f931fff86d7bfd99" }, // Select 1
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearSelect01")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "9f4da4e0e6f70db40b3de33ec3dc91b9" }, // Select 2
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearSelect02")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "14278b3296e98c44dbeb9872efcadf9c" }, // Select 3
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearSelect03")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "0a648a159cafe544db91e2f7a57191ca" }, // Select 4
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearSelect04")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "8398760936ed0a942b64a5fe75a9475b" }, // Select 5
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearSelect05")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "a3f42a87448d2f94c9caeb1a2bede3c0" }, // Select 6
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearSelect05")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "768ea9c5f05530e40a503a10971fe2e3" }, // Select alt 1
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearSelect04")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "6f2db2908559f6344b9bed6ddc464772" }, // Select alt 2
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearSelect03")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "734c58781ca3dea4eb0ab357f880efa0" }, // Unlock
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearUnlock")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "318d3df913dfc9841ba00a3d2af40304" }, // Upgrade 01
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearUpgrade01")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "c45444b6c3a6c504b9ce463482c01b90" }, // Upgrade 02
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearUpgrade02")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "02ad12cb9d10f6f47af214b3ae15b052" }, // Upgrade 03
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearUpgrade03")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "24decd13195c1d142a306a99626f5fea" }, // Upgrade 04
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearUpgrade04")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "5e1291d5416b4f943ba179a2b805fb3f" }, // Upgrade 05
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearUpgrade05")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "2e728b7ea006d7540ac9a76da067e654" }, // Upgrade 06
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearUpgrade04")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "cd0e4fba020a8a44d9584a0ecfe74e84" }, // Upgrade 07
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearUpgrade03")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "1f1f69f88a0109e4ca21259910cad2e6" }, // Upgrade 08
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearUpgrade02")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "4f204ccf132de5746b47c3bc03d7abdf" }, // Upgrade max
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearUpgradeMax")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "b8b82505db537fa4d9bac0d49627fdbb" }, // Warning Moab
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearWarningMoab")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "deedf11caf821954ea6c6532f13fd107" }, // Warning Bfb
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearWarningBfb")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "3b1c2b67dcef50b46bfef9c9636cb804" }, // Warning Zomg
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearWarningZomg")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "7aecd74880d1d7941961cb4c51effdcf" }, // Warning Ddt
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearWarningDdt")
		});

		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "dd255cbda5cc06d419894fd311ebaf5b" }, // Ability 3
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearAbility3")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "cadb35e40baee4e43b0811a46b167dce" }, // Ability 3 alt
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearAbility3")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "1595f59017d5b7c43a5dfaeb99319f39" }, // Ability 10
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearAbility10")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "3106f6d6a6c9eb84b824ed2cdb0d3b48" }, // Ability 10 alt
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearAbility10")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "61f96be9248de294e94e8ad5b44ac751" }, // Leak 1
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearLeak")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "c5f21219ded6c3643ba677c2744f1b08" }, // Leak 2
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearLeak")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "281b2c4821906894ebcc1d98078d3163" }, // Warning Bad
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearWarningBad")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "29d493505c0dcb64b9b8615db6807b9d" }, // Moab Destroyed 1
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearMoabDestroyed01")
		});
		psiSwapAudioContainer.items.Add(new SwapAudio
		{
			assetToReplace = new AudioClipReference { guidRef = "80988e1f4d0d9f446a1e4e1f0a7b5f18" }, // Moab Destroyed 2
			assetReplacement = ModContent.GetAudioClipReference(this, "PsiNewYearMoabDestroyed02")
		});
		...
		var skinDataArray = new Il2CppReferenceArray<SkinData>(3)
		{
			...
			[0] =
			{
				...
				unlockedEventSound = new AudioClipReference {guidRef = "bc0f7e77871e6fb4ab5eacedfc08c082"},
				unlockedVoiceSound = new AudioClipReference {guidRef = "2901d680540a73e46a394390771742bc"},
			...
			[1] =
			{
				...
				unlockedEventSound = new AudioClipReference {guidRef = "bc0f7e77871e6fb4ab5eacedfc08c082"},
				unlockedVoiceSound = ModContent.GetAudioClipReference(this, "PsiNewYearUnlock"),
			...
			[2] =
			{
				...
				unlockedEventSound = new AudioClipReference {guidRef = "bc0f7e77871e6fb4ab5eacedfc08c082"},
				unlockedVoiceSound = new AudioClipReference {guidRef = "6c84fae31334b074f96da54402bcd1d8"},
